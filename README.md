...
* After you click on one of the grids, you can use the arrow keys on the keyboard the set the grid with an arrow with the direction that the key corresponds to, for diagonal directions, just use combinations of the arrow keys (press at the same time) to set the arrow.
